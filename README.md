...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-tissuumaps-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15343&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-tissuumaps-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-tissuumaps` can be installed with:

```
conda install napari-tissuumaps
```

It is possible to list all of the versions of `napari-tissuumaps` available on your platform with:
